          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-xl p-4 flex items-start gap-3">
              ...
              <p className="text-sm text-slate-300 leading-relaxed">
                Pastikan <span className="text-yellow-500 font-bold">{field1Label}</span>{hasField2 && ` dan <span class="text-yellow-500 font-bold">${field2Label}</span>`} sudah benar. Kesalahan input bukan tanggung jawab kami.
              </p>
            </div>
          </div>
        </div>
